...
import { Sprout, Droplets, Scissors, ArrowRight, PlusCircle, History, Layout, Leaf, Hammer, Camera, Scan, X, Activity, ShieldCheck } from 'lucide-react';
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                {taxonomies.slice(0, 3).map((tax, idx) => (
                  <div 
                    ...
                    style={{ background: 'white', padding: '16px', borderRadius: '20px', border: '1px solid #eee', display: 'flex', alignItems: 'center', gap: '16px', cursor: 'pointer', transition: '0.2s', boxShadow: '0 2px 10px rgba(0,0,0,0.02)' }}
