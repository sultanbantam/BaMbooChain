...
const ContributeDataBMC = () => {
  ...
  return (
    <div style={{ animation: 'fadeIn 0.2s', marginTop: '24px' }}>
      ...
      <h3 style={{ fontSize: isMobile ? '1.3rem' : '1.5rem', marginBottom: '8px', fontWeight: '900' }}>Contribute Bamboo Data</h3>
      <p style={{ color: 'var(--text-muted)', marginBottom: '24px', fontSize: '0.9rem' }}>Dapatkan reward <strong>0.5 BMC</strong> untuk setiap observasi yang disetujui.</p>
      ...
      <div style={{ background: 'white', borderRadius: '24px', padding: isMobile ? '24px' : '32px', boxShadow: '0 8px 24px rgba(0,0,0,0.04)', border: '1px solid #f1f3f5' }}>
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '1fr 1fr', gap: isMobile ? '16px' : '20px', marginBottom: '24px' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Nama Lokal Bambu</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Koordinat GPS (Map)</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Estimasi Jumlah Rumpun & Batang</label>
            <div style={{ display: 'flex', gap: '8px' }}>
              <input type="number" placeholder="Rumpun" style={{ flex: 1, padding: '12px', borderRadius: '12px', border: '1.5px solid #e9ecef', fontSize: '0.95rem' }} />
              <input type="number" placeholder="Batang" style={{ flex: 1, padding: '12px', borderRadius: '12px', border: '1.5px solid #e9ecef', fontSize: '0.95rem' }} />
            </div>
          </div>
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Jarak dari Akses Jalan (m/km)</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Jumlah Rebung</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Nama Pemilik Rumpun</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Alamat Pemilik</label>
          ...
          <div>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Nomor WA Pemilik</label>
          ...
          <div style={{ gridColumn: isMobile ? 'auto' : 'span 2' }}>
            <label style={{ display: 'block', marginBottom: '8px', fontSize: '0.85rem', fontWeight: 'bold' }}>Potensi Tambahan</label>
        ...
        <div style={{ background: '#f8f9fa', padding: isMobile ? '20px' : '24px', borderRadius: '20px', marginBottom: '24px', border: '1px dashed #dee2e6' }}>
          <h4 style={{ margin: '0 0 8px 0', fontSize: '1rem', fontWeight: 'bold' }}>Upload Foto</h4>
          <p style={{ margin: '0 0 20px 0', fontSize: '0.8rem', color: 'var(--text-muted)' }}>Pastikan foto diunggah dengan jelas. Klik <strong>Lihat Contoh</strong> agar foto diterima oleh validator.</p>
        ...
        <button onClick={handleSubmit} disabled={loading} style={{ background: '#2ecc71', color: 'white', border: 'none', padding: '20px', borderRadius: '20px', fontWeight: '900', width: '100%', cursor: loading ? 'not-allowed' : 'pointer', fontSize: '1.1rem', boxShadow: '0 10px 25px rgba(46,204,113,0.3)', transition: 'all 0.2s' }}>
          {loading ? 'Mengirim Data...' : 'Kirim Data untuk Validasi'}
        </button>
      </div>
    </div>
  );
